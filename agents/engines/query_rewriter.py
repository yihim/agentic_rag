...
def rewrite_query(llm, query: str, chat_history: List[Union[HumanMessage, AIMessage]], conversation_summary: str):
...
if __name__ == "__main__":
    ...
    start = perf_counter()
    print(rewrite_query(llm=query_writer_llm, query=query, chat_history=chat_history, conversation_summary=conversation_summary))
